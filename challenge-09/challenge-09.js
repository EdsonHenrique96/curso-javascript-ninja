(function main(){
  ...
  */
  var sumResult = sum(function(number1, number2) {
    return number1 + number2;
  })
  ...
  */
  var subtraction = calculator(51, 5);
  var multiplication = calculator(9, 9);
  var division = calculator(70, 7);
  ...
  chamada.
  */
  var subtractionResult = subtraction(function (number1, number2) {
    return number1 - number2;
  })
  console.log( 'O resultado da subtração é: ' + subtractionResult );

  var multiplicationResult = multiplication(function (number1, number2) {
    return number1 * number2;
  })
  console.log( 'O resultado da multiplicação é: ' + multiplicationResult);

  var disivionResult = division(function (number1, number2) {
    return  number1 / number2;
  })
  console.log( 'O resultado da divisão é: ' + disivionResult );

  var modResult = mod(function (number1, number2) {
    return number1 % number2;
  })
  console.log( 'O resto da divisão é: ' + modResult );
})();
