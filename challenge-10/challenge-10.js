(function(){
  ...
  */
  function isOperatorValid(opetator) {
    return !!operation[String(opetator)];
  }
  ...
  */
  ...
  console.log(
    showOperationMessage(operationSignal, number1, number2),
    subtraction ? subtraction(number1, number2) : showErrorMessage(operationSignal)
  );
  ...
  console.log(
    showOperationMessage(operationSignal, number1, number2),
    multiplication ? multiplication(number1, number2) : showErrorMessage(operationSignal)
  );
  ...
  console.log(
    showOperationMessage(operationSignal, number1, number2),
    division ? division(number1, number2) : showErrorMessage(operationSignal)
  );
  ...
  console.log(
    showOperationMessage(operationSignal, number1, number2),
    mod ? mod(number1, number2) : showErrorMessage(operationSignal)
  );
 ...
 console.log(
   showOperationMessage(operationSignal, number1, number2),
   invalid ? invalid(number1, number2) : showErrorMessage(operationSignal)
 );
